            ...
            <footer class="main">
                <div class="f-top-block">
                    ...
                    <div class="buttons">
                        ...
                        <a class="button bg-grey" target="_blank" href="http://rostec.ru">Rostec.ru</a>
                    </div>
                </div>
                <div class="f-bottom-block">
                    ...
                    <?$APPLICATION->IncludeComponent("bitrix:search.form","wk.bottom",
						Array(
					...
					<div class="social">
					<a href="http://vk.com/public102310106" class="vk"><img src="/local/templates/rtinform/img/social_vk.png" alt="" /></a><a href="https://www.facebook.com/rtinform" class="f"><img src="/local/templates/rtinform/img/social_f.png" alt="" /></a>
                    </div>
                </div>
                ...
                <div id="ring_form" style="display: none;">
                    <form action="/local/templates/rtinform/action/feedback.php" id="ringForm">
                ...
                <div id="question_form" style="display: none;">
                    <form action="/local/templates/rtinform/action/question.php" id="questionForm">
                    <h2 class="title_form_name">Регистрация – Встреча по проекту 360</h2>
                    <div class="b-contacts__filed clearfix">
                    ...
                    <div class="b-contacts__filed clearfix">
                         <textarea id="qquestion" name="qquestion" placeholder="Ваша должность" required="required"></textarea>
                    </div>
					<div class="b-contacts__filed clearfix">
						<div class="captcha-block">
							<input type="text" name="v-code" placeholder="Введите проверочный код" required="required"/>
